...
namespace Purchase.Migrations
{
    ...
    [Migration("20251128115835_AddComponentIntegration")]
    partial class AddComponentIntegration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ComponentStandardElectronicComponent", b =>
                {
                    b.Property<int>("ElectronicComponentID")
                        .HasColumnType("integer");

                    b.Property<int>("StandardsID")
                        .HasColumnType("integer");

                    b.HasKey("ElectronicComponentID", "StandardsID");

                    b.HasIndex("StandardsID");

                    b.ToTable("ComponentStandardRelations", (string)null);
                });

            modelBuilder.Entity("Purchase.Data.ComponentStandard", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ComponentStandards");
                });

            modelBuilder.Entity("Purchase.Data.ElectronicComponent", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("LocalizationPercent")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ComponentStandardElectronicComponent", b =>
                {
                    b.HasOne("Purchase.Data.ElectronicComponent", null)
                        .WithMany()
                        .HasForeignKey("ElectronicComponentID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Purchase.Data.ComponentStandard", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Purchase.Data.Proposal", b =>
                {
                    b.HasOne("Purchase.Data.User", "User")
                        .WithMany()
